# ais-pertemuanmahasiswa-bundle
pertemuanmahasiswa Bundle For AIS. I use Symfony 2.7.4 in my kit. In case if you want to install Symfony follow the URL below:
